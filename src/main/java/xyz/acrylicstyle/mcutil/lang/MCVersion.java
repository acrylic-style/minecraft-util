...
public enum MCVersion {
    ...
    /**
     * Checks whether the release is full release (not snapshot, not beta, not release candidate)
     * @return true if this versions is full release
     */
    public boolean isRelease() { return !isSnapshot() && !isBeta() && !isPrerelease() && !isReleaseCandidate() && ordinal() <= v1_0_0.ordinal(); }
