...
public enum MCVersion {
    ...
    v1_19(-1, -1, "1.19"),
    @SnapshotFor(v1_19)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/d7a5cb72158d497983a74623b88f0e0cd423d46f/22w14a.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/1d186d967576d4e6043e5b1664da242c1b686a85/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/cf4f3a6492c0a84e2e852fe0ea714080923ab6ad/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/9b86041edb4aa515fc8951f16e3d3be3e0c0533e/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/7b9857a6a7f3d7910700528627a8912947512178/server.txt")
    @Type(Types.SNAPSHOT)
    SNAPSHOT_22W14A(0x4000004E, 3088, "22w14a"),
    @SnapshotFor(v1_19)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/5f73acb0bfadc51f9535464c6f03b84c358d2b9b/22w13a.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/1156e606bb7272bb1972e3f2ee7c3a498e1bfb6c/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/7c8afca77bb9a73d31cdc70f2f68b4119d581455/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/6c24f90a6b2653803072e82d26814aec59b79eb1/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/5712fbabd1d65667551df47b3f22e72e58158136/server.txt")
    @Type(Types.SNAPSHOT)
    SNAPSHOT_22W13A(0x4000004C, 3085, "22w13a"),
    @SnapshotFor(v1_19)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/4b152e3160f3323ef1b5f2f7a159a575f3ce60ce/22w12a.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/9638f6997fd59545585242eadab1e5039356e77a/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/f238cf129a0848effe5037d8aaefe3f1f350b689/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/b439349831e52fb3231c4e6dda4980b105cd8159/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/66958fd7cba81700445786fd72af15d7163c0d4a/server.txt")
    @Type(Types.SNAPSHOT)
    SNAPSHOT_22W12A(0x4000004B, 3082, "22w12a"),
    @SnapshotFor(v1_19)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/c798c5a14dfbf8a0d18a8348f6c4a35783f372c3/22w11a.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/ae97182a5d2b1f1244c529d0a3b29b33c23ed49c/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/a13b9678c60b0a84767e6cef0086c65cadac036e/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/dbb05f0a348f2c76df6916b6aedcf691fb8c11f0/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/c88f9683d7ac6490f01e58f6710b91689bb14b26/server.txt")
    @Type(Types.SNAPSHOT)
    SNAPSHOT_22W11A(0x4000004A, 3080, "22w11a"),
    @SnapshotFor(v1_19)
    ...
    @ClientJson("https://launchermeta.mojang.com/v1/packages/86f9645f8398ec902cd17769058851e6fead68cf/1.18.2.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/2e9a3e3107cca00d6bc9c97bf7d149cae163ef21/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/c8f83c5655308435b3dcf03c06d9fe8740a77469/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/a661c6a55a0600bd391bdbbd6827654c05b2109c/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/e562f588fea155d96291267465dc3323bfe1551b/server.txt")
    v1_18_2(758, 2975, "1.18.2"),
    @ReleaseCandidateFor(v1_18_2)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/a2fdd5749ab3f214f566c07065788a56cb068611/1.18.2-rc1.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/a2699aadf0435f35cc0694d2f9e9403baac27ee2/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/2f52c69c90d63c024548ae5c5438ff3156ece6c2/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/8b7892d88d0b9a3f7bab25f7cdff0bad7b4bc0c2/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/eeec4456359d8698565acb9d5b67a68cc8885252/server.txt")
    @Name("1.18.2 Release Candidate 1")
    @Type(Types.SNAPSHOT)
    v1_18_2_RC1(0x40000049, 2974, "1.18.2-rc1"),
    @PrereleaseFor(v1_18_2)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/fcc448917e087672f34476aaa27935904d3bb847/1.18.2-pre3.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/8dcc197b6dca3dfa2f6a0d5d3f0ff79de39b4700/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/1c898afff0449eed08ad8036aaa4c652952035de/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/abfe02738e7fc3d2155dd258ec66c8e25f033c5e/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/f023bea3f6cde2dbfa340649d19e163de93224e8/server.txt")
    @Name("1.18.2 Pre-release 3")
    @Type(Types.SNAPSHOT)
    v1_18_2_PRE3(0x40000048, 2973, "1.18.2-pre3"),
    @PrereleaseFor(v1_18_2)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/8da33264b60e2cbe50646235e9fcbe1b5e0d7d43/1.18.2-pre2.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/d0a4d6f3c6ba2232b7e1ac4223f8a93741c8e47a/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/888cb380db39a115cfe978c00922d24536bdd2a5/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/18e0d542e7d5b4a1426bed77818b2e3d93dd5dd6/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/534b35bb75418d46e8a28c83c175a5cb8193f67a/server.txt")
    @Name("1.18.2 Pre-release 2")
    @Type(Types.SNAPSHOT)
    v1_18_2_PRE2(0x40000047, 2972, "1.18.2-pre2"),
    @PrereleaseFor(v1_18_2)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/ab18179469e2ec0bd497d919ca47edf6fb8242e3/1.18.2-pre1.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/501e50015fd24332cd78010a5e57ba42ded41131/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/c3e2734bafdb017efab854b01c66dd795722a332/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/4a6984727e1a3133b9eb54f78d4b01705c7465fb/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/ee44979b031f2e937dd4737ebcfbddd553aee52d/server.txt")
    @Name("1.18.2 Pre-release 1")
    @Type(Types.SNAPSHOT)
    v1_18_2_PRE1(0x40000046, 2971, "1.18.2-pre1"),
    @SnapshotFor(v1_18_2)
    ...
    @ServerJar("https://launcher.mojang.com/v1/objects/60c757a63f21877f8b053904ac76d04ff3cb76ef/server.jar")
    ...
    @ServerJar("https://launcher.mojang.com/v1/objects/e6183efda3cea1871cb090b37ec7e0305d6ebbde/server.jar")
    ...
    @ServerJar("https://launcher.mojang.com/v1/objects/686320be073916ae97b1ad78d22627809491dfc2/server.jar")
    ...
    @ClientMapping("https://launcher.mojang.com/v1/objects/99ade839eacf69b8bed88c91bd70ca660aee47bb/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/9717df2acd926bd4a9a7b2ce5f981bb7e4f7f04a/server.txt")
    v1_18_1(757, 2860, "1.18.1"),
    @ReleaseCandidateFor(v1_18_1)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/fd01124f1b6f10eccaa61b690fcc4233e0b6a63e/1.18.1-rc3.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/26550a328fd4fbf705cffd3703d8ee63163810e3/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/29c43f3af18e66f8368a16ec89f8e54ecda71d85/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/391e64b5fab23ca972fd53eb6597fbc7fed3aed1/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/456f9cdf0ac35c4cc8475e5a285d4ae9ec122138/server.txt")
    @Name("1.18.1 Release Candidate 3")
    @Type(Types.SNAPSHOT)
    v1_18_1_RC3(0x40000040, 2764, "1.18.1-rc3"),
    @ReleaseCandidateFor(v1_18_1)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/9ab6659a95f1a99176357566c18bf1e5c14553c7/1.18.1-rc2.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/816d038208ac127176fde4d6597fd11a0aeb98c7/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/653c704a89fe6437b363cff32ded037d5c0f6ec0/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/17cd609e90409b0b0eebf0ff0c969279bbe34c18/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/7d7bfa82af5af763e01919942b56062267edaf38/server.txt")
    @Name("1.18.1 Release Candidate 2")
    @Type(Types.SNAPSHOT)
    v1_18_1_RC2(0x4000003F, 2763, "1.18.1-rc2"),
    @ReleaseCandidateFor(v1_18_1)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/981bf6aff5a931a9efba0c7806427cff675e6105/1.18.1-rc1.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/e123b3b6b654213cd4f9f381dc17c1ad2f6b2fe2/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/fa98951fb1fa1ca04d8d6283e91e667d91e6410d/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/17cd609e90409b0b0eebf0ff0c969279bbe34c18/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/7d7bfa82af5af763e01919942b56062267edaf38/server.txt")
    @Name("1.18.1 Release Candidate 1")
    @Type(Types.SNAPSHOT)
    v1_18_1_RC1(0x4000003E, 2762, "1.18.1-rc1"),
    @PrereleaseFor(v1_18_1)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/27b951b717795998c22a249e4ad4a302b92989fa/1.18.1-pre1.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/9561f774dcc8797a02a907fc79d946533fbb00c7/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/cd99e68b49c8a7db185d053518c6fb135cd04564/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/2240862fdd181309bb3a34f8472bdb9154d928b6/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/8efe9d1d2db4f1a0d868dd0d1ea30b49b67d9394/server.txt")
    @Name("1.18.1 Pre-release 1")
    @Type(Types.SNAPSHOT)
    v1_18_1_PRE1(0x4000003D, 2761, "1.18.1-pre1"),
    @ClientJson("https://launchermeta.mojang.com/v1/packages/cdd1c0f485c0ea5a5aae60d4e62d316b2141f227/1.18.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/d49eb6caed53d23927648c97451503442f9e26fd/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/3cf24a8694aca6267883b17d934efacc5e44440d/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/e824c89c612c0b9cb438ef739c44726c59bbf679/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/a8fe854e35a69df7289d3f03fc0821f6363f2238/server.txt")
    v1_18(757, 2860, "1.18"),
    @ReleaseCandidateFor(v1_18)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/8d6c34be0b1efb7d8a35e756da40b3e4d4343e6a/1.18-rc4.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/4cf8ed5168308946275308cae955ec70b4379477/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/5889357fe058d867f6e27ee3f033286c430ec91e/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/b64667a23e5ea5f0cc0547241c253d2a72a97c56/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/a36b4033a861c6e9bd3ced78b267e6aeaa75b639/server.txt")
    @Name("1.18 Release Candidate 4")
    @Type(Types.SNAPSHOT)
    v1_18_RC4(0x4000003C, 2759, "1.18-rc4"),
    @ReleaseCandidateFor(v1_18)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/21db6043aabebc4012674572a678f856d666a9d9/1.18-rc3.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/060dd014d59c90d723db87f9c9cedb511f374a71/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/9a03d2c4ec2c737ce9d17a43d3774cdc0ea21030/server.jar")
    @ClientMapping("https://launcher.mojang.com/v1/objects/b64667a23e5ea5f0cc0547241c253d2a72a97c56/client.txt")
    @ServerMapping("https://launcher.mojang.com/v1/objects/a36b4033a861c6e9bd3ced78b267e6aeaa75b639/server.txt")
    @Name("1.18 Release Candidate 3")
    @Type(Types.SNAPSHOT)
    v1_18_RC3(0x4000003B, 2758, "1.18-rc3"),
    @ReleaseCandidateFor(v1_18)
    @ClientJson("https://launchermeta.mojang.com/v1/packages/be0e85e9e15f0c8b02cb2793ee37ea1a0593d7ba/1.18-rc2.json")
    @ClientJar("https://launcher.mojang.com/v1/objects/6d90a50cc252b78f959b5d41c46f8d983efda594/client.jar")
    @ServerJar("https://launcher.mojang.com/v1/objects/96162b8d0af608bee2febe602bdb46942e85f6d8/server.jar")
    ...
    @Name("1.18 Release Candidate 2")
    @Type(Types.SNAPSHOT)
    v1_18_RC2(0x4000003A, 2757, "1.18-rc2"),
    @ReleaseCandidateFor(v1_18)
